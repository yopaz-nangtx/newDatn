                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $list->attendance }} / {{ count($class->students) }}</td>
                                            <td>{{ count($list->homeworks) }}</td>
                                            <td>{{ $list->start_time }}</td>
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="{{ url('lesson/edit/'.$list->id) }}" class="btn btn-sm bg-danger-light {{ $list->is_finished ? 'disabled-link' : '' }}" title="Attendance">
