                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('room/add/page') }}">Profile</a></li>
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('room/add/save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title room-info">User Profile
                                            <span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Capacity (Person) <span class="login-danger">*</span></label>
                                            <input type="text" class="form-control @error('capacity') is-invalid @enderror" name="capacity" placeholder="Enter Capacity" value="{{ old('capacity') }}">
                                            @error('capacity')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
