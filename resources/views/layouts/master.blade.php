...
<body>
    <div class="main-wrapper">
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="{{ Session::get('image_url') ? Session::get('image_url') :
                                asset('../assets/img/profile-user.jpg') }}" width="31"alt="{{ Session::get('name') }}">
                            <div class="user-text">
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{ Session::get('image_url') ? Session::get('image_url') :
                                    asset('../assets/img/profile-user.jpg') }}" alt="{{ Session::get('name') }}" class="avatar-img rounded-circle">
                            </div>
                            <div class="user-text">
                                <h6>{{ Session::get('name') }}</h6>
                                <p class="text-muted mb-0">{{ Session::get('role_name') }}</p>
        ...
        @yield('content')
        <footer>
            <p>Copyright ©  <?php echo date('Y'); ?> Nang Tran Xuan</p>
        </footer>
    
    </div>

	<script src="{{ URL::to('assets/js/api.js') }}"></script>
    ...
    <script src="{{ URL::to('assets/plugins/apexchart/admin-chart-data.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/apexchart/teacher-chart-data.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/apexchart/student-chart-data.js') }}"></script>
