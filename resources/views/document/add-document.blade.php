                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('document/add/page') }}">Document</a></li>
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('document/upload') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title document-info">Document Information
                                            <span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group students-up-files">
                                            ...
                                            <div class="uplod">
                                                <label class="file-upload image-upbtn mb-0 @error('file') is-invalid @enderror">
                                                    Choose File <input type="file" name="file" id="upload" accept="">
                                                </label>
                                                @error('file')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
