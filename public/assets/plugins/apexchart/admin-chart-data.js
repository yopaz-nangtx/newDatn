...
$(document).ready(function () {
    ...
    if ($("#apexcharts-revenue-month-area").length > 0) {
        var options = {
        chart: { height: 350, type: "line", toolbar: { show: false } },
        dataLabels: { enabled: false },
        stroke: { curve: "smooth" },
        ...
        var chart = new ApexCharts(
        document.querySelector("#apexcharts-revenue-month-area"),
        options,
        );
        chart.render();
    }

    if ($("#apexcharts-revenue-year-area").length > 0) {
        var options = {
        chart: { height: 350, type: "line", toolbar: { show: false } },
        dataLabels: { enabled: false },
        stroke: { curve: "smooth" },
        ...
        var chart = new ApexCharts(
        document.querySelector("#apexcharts-revenue-year-area"),
        options,
        );
        chart.render();
    }
